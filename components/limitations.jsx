...
const Limitations = () => {
  return (
    <div className="flex flex-col mt-20 md:mt-2 items-start md:ml-8 lg:-ml-6 h-52 w-full md:grid grid-cols-6 lg:w-[90%]">
      {/* Limitations of BMI */}
      <div className=" md:flex md:flex-col md:justify-start md:mb-20 col-span-6 lg:col-span-3">
        <div className="flex flex-col justify-center items-center lg:items-start lg:ml-12  ">
          <h1 className="text-center text-3xl tracking-tight lg:text-5xl font-semibold md:mb-2 lg:mb-2 ">
            {TEXTS[5].title}
          </h1>
          <p className="mb-20 px-7 md:px-0 lg:pr-7 md:mb-7 mt-6 text-center lg:text-left">
            {TEXTS[5].content}
          </p>
        </div>
      </div>
      {/* gender */}
      <div className="bg-white rounded-xl h-52 w-[85%] mb-5 md:mb-7 md:ml-10  col-span-6 md:col-span-3 lg:col-span-2 shadow-[0_10px_80px_rgba(8,_112,_184,_0.7)] lg:ml-36 lg:mt-2">
      ...
      <div className="hidden lg:block mt-10 ml-10  col-span-2">
        <Image
          ...
          width={95}
          height={95}
          className="ml-48 -mt-16"
        />
      </div>
      {/* age */}
      <div className="bg-white rounded-xl h-52 w-[85%] mb-5 md:mb-7  col-span-6 md:col-span-3 lg:col-span-2 shadow-[0_10px_80px_rgba(8,_112,_184,_0.7)] lg:ml-9">
        <div className="px-6 py-6 md:pr-4 flex flex-col justify-start">
          <div className="flex justify-start items-center mb-4">
      ...
      {/* muscle */}
      <div className="bg-white rounded-xl h-52 w-[85%] mb-5 md:mb-7 md:ml-[75px]  col-span-6 md:col-span-3 lg:col-span-2 shadow-[0_10px_80px_rgba(8,_112,_184,_0.7)]">
        <div className="px-6 py-6 md:pr-4 flex flex-col justify-start">
          <div className="flex justify-start items-center mb-4">
      ...
      {/* race */}
      <div className="bg-white rounded-xl h-60 md:h-52 w-[85%] mb-5 md:mb-7 md:ml-16  col-span-6 md:col-span-4 lg:col-span-2 shadow-[0_10px_80px_rgba(8,_112,_184,_0.7)]">
