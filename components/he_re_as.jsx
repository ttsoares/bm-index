...
const HeReAs = () => {
  return (
    <div className="flex w-full flex-col mt-14 md:mt-20  lg:flex-row  lg:mt-32 bg-[#f8fcff] rounded-xl lg:w-[87%] lg:pb-36">
      <div className="w-full md:mb-3 lg:w-1/3 ">
        <div className="px-8 mt-10 md:px-0 md:mx-auto md:flex md:w-[90%] lg:flex-col ">
          ...
          <div className="md:ml-8 md:pb-6 ">
            <h1 className="text-2xl mb-3 md:-mt-3 lg:pr-0 lg:mt-4 font-semibold lg:mb-8">
              {TEXTS[2].title}
            </h1>
